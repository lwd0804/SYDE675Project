...
We use Intel Image Classification Dataset(https://www.kaggle.com/datasets/puneet6060/intel-image-classification) which contains around 17k images of size 150x150 distributed under 6 categories. There are around 14k images in training set, 3k in test set.
